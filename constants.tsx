...
export const VOICES: VoiceConfig[] = [
  { id: 'Kore', name: 'Kore', description: 'Warm and professional, ideal for narrations.', gender: 'female' },
  { id: 'Puck', name: 'Puck', description: 'Energetic and bright, great for social content.', gender: 'male' },
  { id: 'Charon', name: 'Charon', description: 'Deep, calm, and authoritative.', gender: 'male' },
  { id: 'Fenrir', name: 'Fenrir', description: 'Neutral, clear, and steady.', gender: 'male' },
  { id: 'Zephyr', name: 'Zephyr', description: 'Light, friendly, and approachable.', gender: 'female' },
];
